...
from fearless.asr.espnet_model import ESPnetASRModel
...
class ASRTask(AbsTask):
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRModel:
        ...
        if args.input_size is None:
            ...
            input_size = frontend.output_size() #Removed the hard code for testing speaker incorporation
        else:
            # Give features from data-loader
            args.frontend = None
            args.frontend_conf = {}
            frontend = None
            input_size = args.input_size #Removed the hard code for testing speaker incorporation
